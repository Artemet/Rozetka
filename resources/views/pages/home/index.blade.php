            ...
            <div class="sub_app_button">
                <div class="sub_choice">
                    ...
                    <a href="" class="app">
                        ...
                        Держите скидки до 45%</a>
                    <div class="subs_containers">
                        <div class="choice_computer_things">
                            <h2 class="menu_glav">Помощь</h2>
                            <a href="" class="menu">Доставка и оплата</a>
                            <a href="" class="menu">Кредит</a>
                            <a href="" class="menu">Гарантия</a>
                            <a href="" class="menu">Возврат товара</a>
                            <a href="" class="menu">Сервисные центры</a>
                            <a href="" class="menu">Отследить заказ</a>
                        </div>
                        <div class="sub_choice_show">
                            <div class="sub_part">
                                <h2 class="menu">Информация о компании</h2>
