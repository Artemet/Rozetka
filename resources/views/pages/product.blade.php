        ...
        <div class="information_box">
            <div class="product_preview">
                <div class="choice_img">
                    <div class="img" onclick="img_change(this)">
        ...
        <div class="buy_box">
            ...
            <div class="basket_choice">
                ...
                <div class="buy_information">
                    <img src="{{asset('res/product/buy_information/195695781.png')}}" alt=""
                         class="buy_information">
                    <img src="{{asset('res/product/buy_information/195705300.png')}}" alt=""
                         class="buy_information">
                    <img src="{{asset('res/product/buy_information/195695730.png')}}" alt=""
                         class="buy_information">
                    <img src="{{asset('res/product/buy_information/195695805.png')}}" alt=""
                         class="buy_information">
                    <img src="{{asset('res/product/buy_information/195705380.png')}}" alt=""
                         class="buy_information">
                    <img src="{{asset('res/product/buy_information/227230361.jpg')}}" alt=""
            ...
            <div class="salesman_information">
                ...
                <img src="{{asset('res/veb_name.jpg')}}" alt="">
            </div>
            <img src="{{asset('res/product/buy_information/percent.jpg')}}" alt="" class="percent">
            <div class="delivery_container">
                <p>Доставка в: <a href="#">Київ</a></p>
                ...
                <div class="delivery_part">
                    <img src="{{asset('res/veb_icon.png')}}" alt="">
